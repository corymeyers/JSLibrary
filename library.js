...
// console.log(library.weekDay.name(2))
// console.log(library.hashtag())
// console.log(library.gradeAssigner(93))
// console.log(library.isEven(69))
// console.log(library.smallest(6,6))
// console.log(library.beanCounter("BgytBbb"))
// console.log(library.arraySum([2,4,1]))
